import junitbuild.documentation.GenerateConfigurationParametersLists
...
dependencies {
	...
	// in reports generated by the ApiReportGenerator and GenerateConfigurationParametersLists
...
tasks {
	...
	val generateConfigurationParametersLists = register("generateConfigurationParametersLists", GenerateConfigurationParametersLists::class) {
		metadataJars.from(apiReportClasspath.get().incoming.artifactView {
			componentFilter { it is ProjectComponentIdentifier }
		}.artifacts.artifactFiles)
		outputFile = generatedAsciiDocPath.map { it.file("configuration-parameters-lists.adoc") }
	}
	...
	val generateAsciidocInputs = register("generateAsciidocInputs") {
		dependsOn(
			...
			generateConfigurationParametersLists,
