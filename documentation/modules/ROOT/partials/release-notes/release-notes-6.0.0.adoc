...
[[v6.0.0-overall-improvements]]
=== Overall Improvements

[[v6.0.0-overall-deprecations-and-breaking-changes]]
...
[[v6.0.0-overall-new-features-and-improvements]]
...
[[v6.0.0-junit-platform]]
=== JUnit Platform

[[v6.0.0-junit-platform-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes
...
[[v6.0.0-junit-platform-new-features-and-improvements]]
==== New Features and Improvements
...
* New support for cancelling a running test execution via a `{CancellationToken}` passed
  ...
  xref:advanced-topics/launcher-api.adoc#launcher-cancellation[User Guide] for details
  and a usage example.
...
* Non-printable control characters in display names are now replaced with alternative
  ...
  xref:writing-tests/display-names.adoc[User Guide] for details.
* Stack traces are now pruned up to the test method or lifecycle method.


[[v6.0.0-junit-jupiter]]
=== JUnit Jupiter

[[v6.0.0-junit-jupiter-bug-fixes]]
==== Bug Fixes
...
[[v6.0.0-junit-jupiter-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes
...
[[v6.0.0-junit-jupiter-new-features-and-improvements]]
==== New Features and Improvements
...
[[v6.0.0-junit-vintage]]
=== JUnit Vintage

[[v6.0.0-junit-vintage-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes
...
[[v6.0.0-junit-vintage-new-features-and-improvements]]
==== New Features and Improvements
