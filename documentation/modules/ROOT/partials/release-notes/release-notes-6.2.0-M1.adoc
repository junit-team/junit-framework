...
* Test Engine and Jupiter Extension authors may generate a machine-readable overview
  of configuration parameters. See
  xref:advanced-topics/junit-platform-configuration.adoc[Documenting Configuration
...
* Vintage configuration parameters are documented in `META-INF/junit-platform-configuration-metadata.json`
