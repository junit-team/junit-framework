...
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=first_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedClassDemo.kt[tags=first_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedClassDemo.kt[tags=constructor_injection]
----
--
====

In Java, you can use _records_ to implement parameterized classes that avoid the boilerplate code
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedClassDemo.kt[tags=field_injection]
----
--
====
...
default). If so, their method signatures must follow the same rules as defined for
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ValueSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=NullAndEmptySource_example1]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=NullAndEmptySource_example2]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_example_autodetection]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_include_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_range_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_exclude_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_regex_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=EnumSource_range_exclude_example]
----
--
====
...
NOTE: For conciseness, this snippet assumes that the enclosing test class uses the `PER_CLASS` xref:writing-tests/test-instance-lifecycle.adoc[].
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tag=primitive_MethodSource_example]
----
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=multi_arg_MethodSource_example]
----
...
include::example$kotlin/example/kotlin/ExternalMethodSourceDemo.kt[tags=external_MethodSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ExternalFieldSourceDemo.kt[tags=external_field_FieldSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=CsvSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=CsvFileSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsSource_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsProvider_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsProviderWithConstructorInjection_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=argument_count_validation]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=implicit_conversion_example]
----
--
====
...
- __factory constructor__: a non-private constructor in the target type that accepts
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=implicit_fallback_conversion_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=implicit_fallback_conversion_example_Book]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=explicit_conversion_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=explicit_conversion_example_ToStringArgumentConverter]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=explicit_conversion_example_TypedArgumentConverter]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=explicit_java_time_converter]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsAccessor_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsAggregator_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsAggregator_example_PersonAggregator]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsAggregator_with_custom_annotation_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ArgumentsAggregator_with_custom_annotation_example_CsvToPerson]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=custom_display_names]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedTestDemo.kt[tags=ParameterResolver_example]
----
--
====
...
[source,kotlin,indent=0]
----
include::example$kotlin/example/kotlin/ParameterizedLifecycleDemo.kt[tags=example]
----

NOTE: For conciseness, this snippet uses the `PER_CLASS` xref:writing-tests/test-instance-lifecycle.adoc[].
--
====
