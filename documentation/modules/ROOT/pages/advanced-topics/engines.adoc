...
* A `TestEngine` _may_ xref:advanced-topics/junit-platform-configuration.adoc[document its configuration parameters]
  in `META-INF/junit-platform-configuration-metadata.json`.
